...
friends: $(UTILS) friends.o social_media_friends.o utils.o posts.o
	$(CC) $(CFLAGS) -o $@ $^

posts: $(UTILS) posts.o social_media_posts.o utils.o friends.o
	$(CC) $(CFLAGS) -o $@ $^
	
feed: $(UTILS) posts.o friends.o feed.o social_media_feed.o utils.o 
	$(CC) $(CFLAGS) -o $@ $^
